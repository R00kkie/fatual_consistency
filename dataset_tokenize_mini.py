...
class textDataset(Dataset):
    def __init__(
        ...
        f = open(f'{self.data_path[:-5]}_mini.pkl','wb')
...
if __name__ == '__main__':
    data_loader = textSumDataModule(
        ...
        train_data_dir='./data/DuLeMon_faithfulmatch_v2/DuLeMon_faithfulmatch_v2/train_aug.json',
        test_data_dir='./data/DuLeMon_faithfulmatch_v2/DuLeMon_faithfulmatch_v2/dev_aug.json'
    ).setup()
    print(data_loader)
